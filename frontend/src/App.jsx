...
const FAQ_DATA = {
  french: [
    { q: "Comment télécharger Drople sur iPhone ?", a: "Ouvre dropleapp.com dans Safari (pas Chrome). Appuie sur 📤 Partager → «Sur l'écran d'accueil» → Ajouter. L'icône Drople apparaît sur ton écran d'accueil. Si Drople était déjà installée, supprime-la d'abord pour avoir la dernière version." },
    { q: "Comment l'installer sur Android ?", a: "Ouvre dropleapp.com dans Chrome. Appuie sur ⋮ (les 3 points en haut à droite) → «Installer l'application». L'icône Drople s'ajoute à ton écran d'accueil. Si Drople était déjà installée, désinstalle-la d'abord." },
    ...
    { q: "À quoi servent les catégories ?", a: "Ce sont tes étiquettes personnelles (ex: «Perso», «Travail», «Santé»). Tu les crées manuellement — l'IA ne les génère pas automatiquement." },
  ...
  english: [
    { q: "How to install Drople on iPhone?", a: "Open dropleapp.com in Safari (not Chrome). Tap 📤 Share → 'Add to Home Screen' → Add. The Drople icon will appear on your home screen. If Drople was already installed, delete it first to get the latest version." },
    { q: "How to install on Android?", a: "Open dropleapp.com in Chrome. Tap ⋮ (top-right menu) → 'Install app'. The Drople icon will be added to your home screen. If Drople was already installed, uninstall it first." },
    ...
    { q: "What are categories for?", a: "They are your personal labels (e.g. 'Personal', 'Work', 'Health'). You create them manually — the AI does not generate them automatically." },
  ...
  spanish: [
    { q: "¿Cómo instalar Drople en iPhone?", a: "Abre dropleapp.com en Safari (no Chrome). Toca 📤 Compartir → 'Añadir a pantalla de inicio' → Añadir. Si Drople ya estaba instalada, elimínala primero." },
    { q: "¿Cómo instalarlo en Android?", a: "Abre dropleapp.com en Chrome. Toca ⋮ (arriba a la derecha) → 'Instalar aplicación'. Si Drople ya estaba instalada, desinstálala primero." },
  ...
  italian: [
    { q: "Come installare Drople su iPhone?", a: "Apri dropleapp.com in Safari (non Chrome). Tocca 📤 Condividi → 'Aggiungi alla schermata Home' → Aggiungi. Se Drople era già installata, eliminala prima." },
    { q: "Come installarlo su Android?", a: "Apri dropleapp.com in Chrome. Tocca ⋮ (menu in alto a destra) → 'Installa app'. Se Drople era già installata, disinstallala prima." },
  ...
  portuguese: [
    { q: "Como instalar Drople no iPhone?", a: "Abra dropleapp.com no Safari (não Chrome). Toque em 📤 Compartilhar → 'Adicionar à tela de início' → Adicionar. Se Drople já estava instalado, exclua primeiro." },
    { q: "Como instalar no Android?", a: "Abra dropleapp.com no Chrome. Toque em ⋮ (menu no canto superior direito) → 'Instalar app'. Se Drople já estava instalado, desinstale primeiro." },
  ...
  chinese: [
    { q: "如何在iPhone上安装Drople？", a: "在Safari中打开dropleapp.com（不要用Chrome）→ 点击📤分享 → 「添加到主屏幕」→ 添加。如果之前已安装，请先删除旧版本。" },
    { q: "如何在Android上安装？", a: "在Chrome中打开dropleapp.com → 点击⋮（右上角）→「安装应用」。如果之前已安装，请先卸载旧版本。" },
  ...
  russian: [
    { q: "Как установить Drople на iPhone?", a: "Откройте dropleapp.com в Safari (не Chrome). Нажмите 📤 Поделиться → «На экран Домой» → Добавить. Если Drople уже была установлена, сначала удалите её." },
    { q: "Как установить на Android?", a: "Откройте dropleapp.com в Chrome. Нажмите ⋮ (вверху справа) → «Установить приложение». Если Drople уже была установлена, сначала удалите её." },
